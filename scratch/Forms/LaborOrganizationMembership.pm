...
# form_generator.pl --rs_name=LaborOrganizationMembership --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationMembership;
    ...
    has '+item_class' => ( default => 'LaborOrganizationMembership' );
