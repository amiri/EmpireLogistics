...
# form_generator.pl --rs_name=RailSubdivisionState --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailSubdivisionState;
    ...
    has '+item_class' => ( default => 'RailSubdivisionState' );
