...
# form_generator.pl --rs_name=LaborOrganizationOtherLiability --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationOtherLiability;
    ...
    has '+item_class' => ( default => 'LaborOrganizationOtherLiability' );
