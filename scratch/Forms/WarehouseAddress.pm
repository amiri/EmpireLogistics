...
# form_generator.pl --rs_name=WarehouseAddress --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::WarehouseAddress;
    ...
    has '+item_class' => ( default => 'WarehouseAddress' );
