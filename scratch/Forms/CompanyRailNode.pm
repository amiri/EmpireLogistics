...
# form_generator.pl --rs_name=CompanyRailNode --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::CompanyRailNode;
    ...
    has '+item_class' => ( default => 'CompanyRailNode' );
