...
# form_generator.pl --rs_name=RailSignal --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailSignal;
    ...
    has '+item_class' => ( default => 'RailSignal' );
