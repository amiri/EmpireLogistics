...
# form_generator.pl --rs_name=RailMilitary --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailMilitary;
    ...
    has '+item_class' => ( default => 'RailMilitary' );
