...
# form_generator.pl --rs_name=RailPassenger --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailPassenger;
    ...
    has '+item_class' => ( default => 'RailPassenger' );
