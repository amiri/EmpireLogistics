...
# form_generator.pl --rs_name=PortWorkStoppage --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortWorkStoppage;
    ...
    has '+item_class' => ( default => 'PortWorkStoppage' );
