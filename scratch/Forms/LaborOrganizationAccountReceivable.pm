...
# form_generator.pl --rs_name=LaborOrganizationAccountReceivable --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationAccountReceivable;
    ...
    has '+item_class' => ( default => 'LaborOrganizationAccountReceivable' );
