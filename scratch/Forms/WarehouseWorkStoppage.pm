...
# form_generator.pl --rs_name=WarehouseWorkStoppage --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::WarehouseWorkStoppage;
    ...
    has '+item_class' => ( default => 'WarehouseWorkStoppage' );
