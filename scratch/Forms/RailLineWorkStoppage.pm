...
# form_generator.pl --rs_name=RailLineWorkStoppage --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailLineWorkStoppage;
    ...
    has '+item_class' => ( default => 'RailLineWorkStoppage' );
