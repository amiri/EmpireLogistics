...
# form_generator.pl --rs_name=LaborOrganizationGeneralDisbursement --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationGeneralDisbursement;
    ...
    has '+item_class' => ( default => 'LaborOrganizationGeneralDisbursement' );
