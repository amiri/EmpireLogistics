...
# form_generator.pl --rs_name=LaborOrganizationOtherAsset --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationOtherAsset;
    ...
    has '+item_class' => ( default => 'LaborOrganizationOtherAsset' );
