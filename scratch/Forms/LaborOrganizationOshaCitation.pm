...
# form_generator.pl --rs_name=LaborOrganizationOshaCitation --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationOshaCitation;
    ...
    has '+item_class' => ( default => 'LaborOrganizationOshaCitation' );
