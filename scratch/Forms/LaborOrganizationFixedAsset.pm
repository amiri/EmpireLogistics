...
# form_generator.pl --rs_name=LaborOrganizationFixedAsset --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationFixedAsset;
    ...
    has '+item_class' => ( default => 'LaborOrganizationFixedAsset' );
