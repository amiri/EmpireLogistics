...
# form_generator.pl --rs_name=LaborOrganizationAffiliation --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationAffiliation;
    ...
    has '+item_class' => ( default => 'LaborOrganizationAffiliation' );
