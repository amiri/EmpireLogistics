...
# form_generator.pl --rs_name=PortShelter --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortShelter;
    ...
    has '+item_class' => ( default => 'PortShelter' );
