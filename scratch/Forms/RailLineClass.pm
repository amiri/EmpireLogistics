...
# form_generator.pl --rs_name=RailLineClass --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailLineClass;
    ...
    has '+item_class' => ( default => 'RailLineClass' );
