...
# form_generator.pl --rs_name=CompanyAddress --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::CompanyAddress;
    ...
    has '+item_class' => ( default => 'CompanyAddress' );
