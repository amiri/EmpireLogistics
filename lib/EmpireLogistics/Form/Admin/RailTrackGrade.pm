...
# form_generator.pl --rs_name=RailTrackGrade --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailTrackGrade;
    ...
    has '+item_class' => ( default => 'RailTrackGrade' );
