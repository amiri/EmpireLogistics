...
# form_generator.pl --rs_name=LaborOrganizationRailNode --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationRailNode;
    ...
    has '+item_class' => ( default => 'LaborOrganizationRailNode' );
