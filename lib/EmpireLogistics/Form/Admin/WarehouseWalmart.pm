...
# form_generator.pl --rs_name=WarehouseWalmart --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::WarehouseWalmart;
    ...
    has '+item_class' => ( default => 'WarehouseWalmart' );
