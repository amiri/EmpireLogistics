...
# form_generator.pl --rs_name=LaborOrganizationWorkStoppage --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationWorkStoppage;
    ...
    has '+item_class' => ( default => 'LaborOrganizationWorkStoppage' );
