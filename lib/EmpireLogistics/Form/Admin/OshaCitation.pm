...
has '+name'       => ( default => 'osha-citation-form' );
has '+item_class' => ( default => 'OshaCitation' );
has 'js_files'    => (
    is      => 'ro',
    isa     => 'ArrayRef',
    default => sub {
        [ '/js/admin/osha-citation.js', ];
    },
);
...
has_block 'basic_block' => (
    ...
    render_list => [ 'inspection_number', 'citation_number', 'issuance_date', 'url', ],
);
