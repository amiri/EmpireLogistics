...
# form_generator.pl --rs_name=CompanyWarehouse --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::CompanyWarehouse;
    ...
    has '+item_class' => ( default => 'CompanyWarehouse' );
