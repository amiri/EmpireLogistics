...
# form_generator.pl --rs_name=LaborOrganizationAccountPayable --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationAccountPayable;
    ...
    has '+item_class' => ( default => 'LaborOrganizationAccountPayable' );
