...
# form_generator.pl --rs_name=RailTrackType --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailTrackType;
    ...
    has '+item_class' => ( default => 'RailTrackType' );
