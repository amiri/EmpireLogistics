...
# form_generator.pl --rs_name=EditHistory --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::EditHistory;
    ...
    has '+item_class' => ( default => 'EditHistory' );
    ...
    has_field 'edit_history_fields' => ( type => '+EditHistoryFieldField', );
...

{
    ...
    package EmpireLogistics::Form::Admin::EditHistoryFieldField;
