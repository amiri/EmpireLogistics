...
# form_generator.pl --rs_name=PortDepthFeet --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortDepthFeet;
    ...
    has '+item_class' => ( default => 'PortDepthFeet' );
