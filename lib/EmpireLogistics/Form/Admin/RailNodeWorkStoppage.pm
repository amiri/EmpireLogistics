...
# form_generator.pl --rs_name=RailNodeWorkStoppage --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailNodeWorkStoppage;
    ...
    has '+item_class' => ( default => 'RailNodeWorkStoppage' );
