...
# form_generator.pl --rs_name=PortRepair --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortRepair;
    ...
    has '+item_class' => ( default => 'PortRepair' );
