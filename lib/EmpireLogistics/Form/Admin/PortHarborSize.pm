...
# form_generator.pl --rs_name=PortHarborSize --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortHarborSize;
    ...
    has '+item_class' => ( default => 'PortHarborSize' );
