...
# form_generator.pl --rs_name=CompanyPort --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::CompanyPort;
    ...
    has '+item_class' => ( default => 'CompanyPort' );
