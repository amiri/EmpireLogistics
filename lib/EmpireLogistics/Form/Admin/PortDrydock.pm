...
# form_generator.pl --rs_name=PortDrydock --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortDrydock;
    ...
    has '+item_class' => ( default => 'PortDrydock' );
