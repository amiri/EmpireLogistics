...
# form_generator.pl --rs_name=LaborOrganizationPort --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationPort;
    ...
    has '+item_class' => ( default => 'LaborOrganizationPort' );
