...
# form_generator.pl --rs_name=PortHarborType --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::PortHarborType;
    ...
    has '+item_class' => ( default => 'PortHarborType' );
