...
# form_generator.pl --rs_name=LaborOrganizationNlrbDecision --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationNlrbDecision;
    ...
    has '+item_class' => ( default => 'LaborOrganizationNlrbDecision' );
