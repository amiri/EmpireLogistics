...
# form_generator.pl --rs_name=LaborOrganizationWarehouse --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationWarehouse;
    ...
    has '+item_class' => ( default => 'LaborOrganizationWarehouse' );
