...
# form_generator.pl --rs_name=RailDensity --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailDensity;
    ...
    has '+item_class' => ( default => 'RailDensity' );



    has_field 'detail' => ( type => 'TextArea', required => 1, );

    has_field 'name' => ( type => 'Integer', required => 1, );
