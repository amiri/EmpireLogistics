...
# form_generator.pl --rs_name=LaborOrganizationPayeeAddress --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationPayeeAddress;
    ...
    has '+item_class' => ( default => 'LaborOrganizationPayeeAddress' );
