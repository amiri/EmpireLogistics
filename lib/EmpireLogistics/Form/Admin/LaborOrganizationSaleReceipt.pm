...
# form_generator.pl --rs_name=LaborOrganizationSaleReceipt --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationSaleReceipt;
    ...
    has '+item_class' => ( default => 'LaborOrganizationSaleReceipt' );
