...
# form_generator.pl --rs_name=LaborOrganizationMember --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::LaborOrganizationMember;
    ...
    has '+item_class' => ( default => 'LaborOrganizationMember' );
