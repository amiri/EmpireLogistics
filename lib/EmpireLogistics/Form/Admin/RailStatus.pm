...
# form_generator.pl --rs_name=RailStatus --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::RailStatus;
    ...
    has '+item_class' => ( default => 'RailStatus' );
