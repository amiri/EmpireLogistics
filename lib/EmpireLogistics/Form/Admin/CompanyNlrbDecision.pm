...
# form_generator.pl --rs_name=CompanyNlrbDecision --schema_name=EmpireLogistics::Schema --db_dsn=dbi:Pg:dbname=empireLogistics

{

    package EmpireLogistics::Form::Admin::CompanyNlrbDecision;
    ...
    has '+item_class' => ( default => 'CompanyNlrbDecision' );
