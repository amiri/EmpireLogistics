package EmpireLogistics::Form::Field::LaborOrganizationSaleReceipt;
...
sub _build_item {
    ...
    my $receipt = $self->form->item->labor_organization_sale_receipts->find(
        {
...
sub render_rm_element {
    ...
    my $rel  = $self->parent->form->sale_receipt_relation;
    return
