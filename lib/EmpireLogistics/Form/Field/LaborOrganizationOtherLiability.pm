package EmpireLogistics::Form::Field::LaborOrganizationOtherLiability;
...
sub render_rm_element {
    ...
    my $rel  = $self->parent->form->other_liability_relation;
    return
...
sub validate {
    ...
    $self->field('year')->add_error("Miscellaneous liability year required")
        if $year_required;
}
