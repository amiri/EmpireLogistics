package EmpireLogistics::Schema::Result::CompanyType;
...
__PACKAGE__->table("company_type");
...
__PACKAGE__->add_unique_constraint("company_type_unique_name", ["name"]);

__PACKAGE__->has_many(
    "companies" => "EmpireLogistics::Schema::Result::Company",
    {"foreign.company_type" => "self.id"},
    {
