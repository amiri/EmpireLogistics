package EmpireLogistics::Schema::Result::CompanyRailLine;
...
__PACKAGE__->table("company_rail_line");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "company_rail_line_id_seq",
  },
  "create_time",
  {
...
__PACKAGE__->add_unique_constraint(
  "company_rail_line_company_rail_line_key",
  ["company", "rail_line"],
);
