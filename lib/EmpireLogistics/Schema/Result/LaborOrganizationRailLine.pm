package EmpireLogistics::Schema::Result::LaborOrganizationRailLine;
...
__PACKAGE__->table("labor_organization_rail_line");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "labor_organization_rail_line_id_seq",
  },
  "create_time",
  {
...
__PACKAGE__->add_unique_constraint(
  "labor_organization_rail_line_labor_organization_rail_line_key",
  ["labor_organization", "rail_line"],
);
