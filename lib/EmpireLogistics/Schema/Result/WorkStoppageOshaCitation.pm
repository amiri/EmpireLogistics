package EmpireLogistics::Schema::Result::WorkStoppageOshaCitation;
...
__PACKAGE__->table("work_stoppage_osha_citation");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "work_stoppage_osha_citation_id_seq",
  },
  "create_time",
  {
...
__PACKAGE__->add_unique_constraint(
  "work_stoppage_osha_citation_work_stoppage_osha_citation_key",
  ["work_stoppage", "osha_citation"],
);
