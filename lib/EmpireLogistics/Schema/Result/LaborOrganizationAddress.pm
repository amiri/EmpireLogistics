...
__PACKAGE__->add_columns(
  ...
  "create_time",
  {
    ...
    default_value => "2014-02-27 14:49:06.45391+00",
    is_nullable   => 0,
  },
  "update_time",
  {
...
__PACKAGE__->add_unique_constraint(
  "labor_organization_address_labor_organization_address_key",
  ["labor_organization", "address"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CmC+3c0Z7LZJru1vSuyIiA
