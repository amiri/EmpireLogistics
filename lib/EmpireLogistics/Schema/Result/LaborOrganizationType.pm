package EmpireLogistics::Schema::Result::LaborOrganizationType;
...
__PACKAGE__->table("labor_organization_type");
__PACKAGE__->add_columns(
  "id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "labor_organization_type_id_seq",
  },
  "create_time",
  {
...
__PACKAGE__->add_unique_constraint("labor_organization_type_unique_name", ["name"]);
__PACKAGE__->has_many(
    "labor_organizations" => "EmpireLogistics::Schema::Result::LaborOrganization",
    {"foreign.organization_type" => "self.id"},
    {
