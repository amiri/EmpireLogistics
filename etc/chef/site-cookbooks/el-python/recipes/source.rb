...
# so that distutils will not think we can do hard links.
# The second is for the same reason, in order to avoid
# attempts to do hard links from the make install step.
